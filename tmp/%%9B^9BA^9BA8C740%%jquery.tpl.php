...
var pclose=<?php if ($this->_tpl_vars['working']): ?>true<?php else: ?>false<?php endif; ?>;
<?php echo '
...
$(\'table tr td:not(:last-child)\').click(function(){
	...
	<?php if (! $this->_tpl_vars['stopinterval'] && $this->_tpl_vars['auth']['user_id']): ?>
